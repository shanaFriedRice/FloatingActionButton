...
define([
    ...
    return declare("FloatingActionButton.widget.FloatingActionButtonNoContext", [ _WidgetBase, _TemplatedMixin ], {
...
require(["FloatingActionButton/widget/FloatingActionButtonNoContext"]);
